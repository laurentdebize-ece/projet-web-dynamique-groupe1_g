...
if (isset($_POST["button1"])){
    if ($conn) {
        ...
        if (mysqli_num_rows($result) == 0) {
            echo "<p>La compétence n'existe pas. Veuillez resaisir un id qui existe.</p>";
        }else{
    ...
    if ($conn) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            if ($result) {
                ...
                $sql = mysqli_query($conn, ' SELECT * FROM competences ');
                if (mysqli_num_rows($sql) != 0) {
                    echo "<h2>Voici les compétences restantes :</h2>";
                    echo "<table border='1'>";
                    echo "<tr>";
                    echo "<th>id</th>";
                    echo "<th>nom</th>";
